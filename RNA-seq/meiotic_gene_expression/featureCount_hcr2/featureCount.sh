...
dirIn="/datasets/data_4/nison/hcr2/RNA-seq/02_STAR"

col_s_1="$dirIn/Col-0-seedling1_Aligned.sortedByCoord.out.bam"
col_s_2="$dirIn/Col-0-seedling2_Aligned.sortedByCoord.out.bam"
col_s_3="$dirIn/Col-0-seedling3_Aligned.sortedByCoord.out.bam"
col_s_4="$dirIn/Col-0-seedling4_Aligned.sortedByCoord.out.bam"

col_b_1="$dirIn/Col-0-bud-19_Aligned.sortedByCoord.out.bam"
col_b_2="$dirIn/Col-0-bud-20_Aligned.sortedByCoord.out.bam"
col_b_3="$dirIn/Col-0-bud-21_Aligned.sortedByCoord.out.bam"
col_b_4="$dirIn/Col-0-bud-22_Aligned.sortedByCoord.out.bam"

hcr2_b_1="$dirIn/hcr2-bud-23_Aligned.sortedByCoord.out.bam"
hcr2_b_2="$dirIn/hcr2-bud-24_Aligned.sortedByCoord.out.bam"
hcr2_b_3="$dirIn/hcr2-bud-25_Aligned.sortedByCoord.out.bam"
hcr2_b_4="$dirIn/hcr2-bud-26_Aligned.sortedByCoord.out.bam"


dirOut="/datasets/data_4/nison/hcr3/HCR3_public_release/RNA-seq/meiotic_gene_expression/featureCount_hcr2"
mkdir -p $dirOut
outfile="hcr2" # outfile prefix
...
featureCounts -T 20 -s 1 -g gene_id -p -t exon \
    ...
    $col_s_1 $col_s_2 $col_s_3 $col_s_4 \
    $col_b_1 $col_b_2 $col_b_3 $col_b_4 \
