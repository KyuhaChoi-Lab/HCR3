...
mkdir -p $dirOut
outfile="Col_s_b_from_hcr10D_hei10" # outfile prefix
...
gtf='/datasets/data_4/nison/hcr3/HCR3_public_release/RNA-seq/meiotic_gene_expression/featureCount_hcr10D_hei10/HEI10_exons_selected_to_be_counted.gtf'
