...
res_colb_cols_3 <- deseqRes(dds, "Col_s_A", "Col_b_D")
...
write.csv(res_colb_cols_3, file=file.path(outputpath, "deseq_results", "deseqResShrunken_col-b-from-hcr2_vs_col-s-from-hcr11D.csv"))
